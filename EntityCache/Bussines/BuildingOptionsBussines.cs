...
{
    public class BuildingOptionsBussines
    {
        public static async Task<ReturnedSaveFuncInfo> SaveAsync(WebBuildingOptions item, Guid customerGuid, SqlTransaction tr = null)
        {
